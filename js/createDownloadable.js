...
function createDownloadableContentFor3FRegion() {
  ...
  var $btn_downloadCSVRegion = $('#btn_downloadCSVRegion');
  $btn_downloadCSVRegion.attr({
    href: blobUrl,
    download: fileName
  });
}
...
function createDownloadableContentFor3FPersonnel() {
  ...
  var $btn_downloadCSVPersonnel = $('#btn_downloadCSVPersonnel');
  $btn_downloadCSVPersonnel.attr({
    href: blobUrl,
    download: fileName
  });
}
